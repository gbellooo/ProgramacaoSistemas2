...
public class App {
    static String url = "jdbc:postgresql://aws-1-sa-east-1.pooler.supabase.com:6543/postgres?user=postgres.qvusurjoazclggvxrgvp&password=mackenzie@java&sslmode=require";
